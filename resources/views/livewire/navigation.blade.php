<nav class="fixed top-0 inset-x-0 z-50 bg-gray-200 font-medium shadow-lg"
    ...
    <div x-show="showMobileMenu">
        <div class="px-2 pt-2 pb-3 space-y-1 lg:hidden md:hidden">
        @if ((request()->is('/')))
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                ...
                <a href="{{ route('manage') }}"
                   class="text-gray-900 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium capitalize">{{ trans('multi-leng.manage') }}</a>
                <a href="{{ route('videos') }}"
